                ...
                for (int i = 0; i < Chart.notes[player].Count; i++) {
                    ...
                    if (delta < Methods.pGameInfo[player].hitWindow) {
                        if (btn == GuitarButtons.green && n.isGreen) {
                            Methods.Hit((int)delta, n.time, Notes.green, player, false);
                            if (n.length[1] != 0)
                        ...
                        if (btn == GuitarButtons.red && n.isRed) {
                            Methods.Hit((int)delta, n.time, Notes.red, player, false);
                            if (n.length[2] != 0)
                        ...
                        if (btn == GuitarButtons.yellow && n.isYellow) {
                            Methods.Hit((int)delta, n.time, Notes.yellow, player, false);
                            if (n.length[3] != 0)
                        ...
                        if (btn == GuitarButtons.blue && n.isBlue) {
                            Methods.Hit((int)delta, n.time, Notes.blue, player, false);
                            if (n.length[4] != 0)
                        ...
                        if (btn == GuitarButtons.orange && n.isOrange) {
                            Methods.Hit((int)delta, n.time, Notes.orange, player, false);
                            if (n.length[5] != 0)
                        ...
                        if (btn == GuitarButtons.open && n.isOpen) {
                            Chart.notes[player].RemoveAt(i);
                            Methods.Hit((int)delta, n.time, Notes.open, player, false);
                            break;
                        }
                    }
                }
