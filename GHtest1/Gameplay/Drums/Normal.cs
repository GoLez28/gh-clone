                ...
                for (int i = 0; i < Chart.notes[player].Count; i++) {
                    ...
                    if (delta < Gameplay.Methods.pGameInfo[player].hitWindow) {
                        if (btn == GuitarButtons.green && n.isGreen) {
                            Gameplay.Methods.Hit((int)delta, (long)time, Notes.green, player, false);
                            if (n.length[1] != 0)
                        ...
                        if (btn == GuitarButtons.red && n.isRed) {
                            Gameplay.Methods.Hit((int)delta, (long)time, Notes.red, player, false);
                            if (n.length[2] != 0)
                        ...
                        if (btn == GuitarButtons.yellow && n.isYellow) {
                            Gameplay.Methods.Hit((int)delta, (long)time, Notes.yellow, player, false);
                            if (n.length[3] != 0)
                        ...
                        if (btn == GuitarButtons.blue && n.isBlue) {
                            Gameplay.Methods.Hit((int)delta, (long)time, Notes.blue, player, false);
                            if (n.length[4] != 0)
                        ...
                        if (btn == GuitarButtons.orange && n.isOrange) {
                            Gameplay.Methods.Hit((int)delta, (long)time, Notes.orange, player, false);
                            if (n.length[5] != 0)
                        ...
                        if (btn == GuitarButtons.open && n.isOpen) {
                            Chart.notes[player].RemoveAt(i);
                            Gameplay.Methods.Hit((int)delta, (long)time, Notes.open, player, false);
                            break;
                        }
                    }
                }
