...
namespace Upbeat.Gameplay.Mania {
    class Normal {
        public static void In(GameInput gi, int type, long time, int player, GuitarButtons btn) {
            ...
            //                Gameplay.Methods.Hit((int)delta, n, Notes.green, player, false);
            //                if (n.length[1] != 0)
            ...
            //                Gameplay.Methods.Hit((int)delta, n, Notes.red, player, false);
            //                if (n.length[2] != 0)
            ...
            //                Gameplay.Methods.Hit((int)delta, n, Notes.yellow, player, false);
            //                if (n.length[3] != 0)
            ...
            //                Gameplay.Methods.Hit((int)delta, n, Notes.blue, player, false);
            //                if (n.length[4] != 0)
            ...
            //                Gameplay.Methods.Hit((int)delta, n, Notes.orange, player, false);
            //                if (n.length[5] != 0)
            ...
            //                Chart.notes[player].RemoveAt(i);
            //                Gameplay.Methods.Hit((int)delta, n, Notes.open, player, false);
            //                break;
            //            }
            //        }
            //    }
